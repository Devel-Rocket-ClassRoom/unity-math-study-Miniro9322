...
public class Assignment_RotationTrail : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Matrix4x4 parentMatrix = Matrix4x4.TRS(Vector3.zero, transform.rotation, transform.localScale);
        transform.position = parentMatrix.MultiplyPoint(new Vector3(0f, armLength, 0f));
